...
let confige = JSON.parse(fs.readFileSync("./config.json", "UTF8"));
client.on("message", message => {
    ...
    if (!confige[message.guild.id]) confige[message.guild.id] = {
        banLimit: 3,
        chaDelLimit: 3,
        roleDelLimit: 3,
        kickLimits: 3,
    ...
    if (message.content.startsWith(prefix + "settings limits")) {
        ...
        if (message.content.startsWith(prefix + "settings limitsban")) {
            ...
            confige[message.guild.id].banLimit = num;
            message.channel.send(`**⇏ | changed to : ${confige[message.guild.id].banLimit} **`)
        }
        if (message.content.startsWith(prefix + "settings limitskick")) {
                        if (!num) return message.channel.send("**⇏ | send a number ! ! **");
                        if (isNaN(num)) return message.channel.send("**⇏ | numbers only ! **");
            confige[message.guild.id].kickLimits = num;
            message.channel.send(`**⇏ | changed to : ${confige[message.guild.id].kickLimits}**`)
        }
        if (message.content.startsWith(prefix + "settings limitsroleD")) {
                        if (!num) return message.channel.send("**⇏ | send a number ! ! **");
                        if (isNaN(num)) return message.channel.send("**⇏ | numbers only ! **");
            confige[message.guild.id].roleDelLimit = num;
            message.channel.send(`**⇏ | changed to : ${confige[message.guild.id].roleDelLimit}**`)
        }
        if (message.content.startsWith(prefix + "settings limitsroleC")) {
                        if (!num) return message.channel.send("**⇏ | send a number ! ! **");
                        if (isNaN(num)) return message.channel.send("**⇏ | numbers only ! **");
            confige[message.guild.id].roleCrLimits = num;
            message.channel.send(`**⇏ | changed to : ${confige[message.guild.id].roleCrLimits}**`)
        }
        if (message.content.startsWith(prefix + "settings limitschannelD")) {
                        if (!num) return message.channel.send("**⇏ | send a number ! ! **");
                        if (isNaN(num)) return message.channel.send("**⇏ | numbers only ! **");
            confige[message.guild.id].chaDelLimit = num;
            message.channel.send(`**⇏ | changed to : ${confige[message.guild.id].chaDelLimit}**`)
        }
        if (message.content.startsWith(prefix + "settings limitstime")) {
                        if (!num) return message.channel.send("**⇏ | send a number ! ! **");
                        if (isNaN(num)) return message.channel.send("**⇏ | numbers only ! **");
            confige[message.guild.id].time = num;
            message.channel.send(`**⇏ | changed to : ${confige[message.guild.id].time}**`)
        }
        fs.writeFile("./config.json", JSON.stringify(confige, null, 2), function (e) {
            if (e) throw e;
        });
